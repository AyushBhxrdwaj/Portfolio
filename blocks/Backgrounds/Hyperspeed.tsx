  ...
  init() {
    ...
    class StraightLineCurve {
      ...
      getPoint(t: number, optionalTarget = new THREE.Vector3()) {
        return optionalTarget.copy(this.start).lerp(this.end, t);
      }
    }
    const curve = new StraightLineCurve(
      new THREE.Vector3(0, 0, 0),
      new THREE.Vector3(0, 0, -1)
    );
    const geometry = new THREE.TubeGeometry(
      curve as unknown as any,
      40,
      1,
      8,
      false
...
const carLightsVertex = `
  ...
  void main() {
    ...
    vUv = uv;
    vColor = aColor;
  ${(THREE as any).ShaderChunk["fog_vertex"]}
  }
`;
