...
export default function TiltedCard({
  ...
  return (
    <figure
      ref={ref}
      className="relative w-full h-full [perspective:800px] flex flex-col items-center justify-center sm:300px"
      style={{
    ...
    >
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-lg bg-black/90 text-white font-medium px-[10px] py-[4px] text-[15px] opacity-0 z-[3] hidden sm:block"
          style={{
            x,
            y,
            opacity,
